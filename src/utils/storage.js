...
function getGithubClientId() {
  const config = loadConfig()
  return config.githubClientId || process.env.GITHUB_CLIENT_ID || null
}
...
module.exports = { getAuth, setAuth, clearAuth, getApiUrl, setApiUrl, DEFAULT_API_URL, getGithubClientId }